            ...
            {submitted ? (
              <div style={{ padding:"10px 0", animation:"fadeUp 0.4s ease" }}>
                <div style={{ textAlign:"center", marginBottom:20 }}>
                  ...
                  <div style={{ fontFamily:"'Syne',sans-serif", fontWeight:800, fontSize:20, color:"#1a1a1a", marginBottom:6 }}>{lang==="fr"?"Inscription réussie!":"Registration successful!"}</div>
                ...
                <div style={{ background:"linear-gradient(135deg,#1a1a1a,#2d1f0e)", borderRadius:16, padding:"20px", marginBottom:16, textAlign:"center" }}>
                  <div style={{ fontSize:11, color:"#F4A261", fontFamily:"'Syne',sans-serif", fontWeight:700, letterSpacing:1, marginBottom:8, textTransform:"uppercase" }}>{lang==="fr"?"Montant à payer":"Amount to pay"}</div>
                  <div style={{ fontFamily:"'Syne',sans-serif", fontWeight:800, fontSize:36, color:"#fff" }}>{joinForm.plan==="premium"?"5.000":"2.000"} <span style={{ fontSize:16, color:"#F4A261" }}>FCFA</span></div>
                ...
                <div style={{ background:"#fff8e1", border:"1.5px solid #FFD54F", borderRadius:14, padding:"16px", marginBottom:12 }}>
                  <div style={{ display:"flex", alignItems:"center", gap:10, marginBottom:10 }}>
                    ...
                    <div style={{ fontFamily:"'Syne',sans-serif", fontWeight:800, fontSize:14, color:"#1a1a1a" }}>MTN Mobile Money</div>
                  </div>
                  <div style={{ fontSize:12, color:"#555", lineHeight:1.8 }}>
                    ...
                    <div style={{ background:"#FFD54F44", borderRadius:8, padding:"8px 12px", marginTop:6, fontFamily:"'Syne',sans-serif", fontWeight:800, fontSize:16, color:"#1a1a1a", textAlign:"center" }}>📞 682 735 988</div>
                  </div>
                </div>
                ...
                <div style={{ background:"#fff3e0", border:"1.5px solid #FF9800", borderRadius:14, padding:"16px", marginBottom:16 }}>
                  <div style={{ display:"flex", alignItems:"center", gap:10, marginBottom:10 }}>
                    ...
                    <div style={{ fontFamily:"'Syne',sans-serif", fontWeight:800, fontSize:14, color:"#1a1a1a" }}>Orange Money</div>
                  </div>
                  <div style={{ fontSize:12, color:"#555", lineHeight:1.8 }}>
                    1. {lang==="fr"?"Composez":"Dial"} <strong>#150*50#</strong><br/>
                    2. {lang==="fr"?"Choisissez Envoyer de l'argent":"Choose Send money"}<br/>
                    3. {lang==="fr"?"Envoyez":"Send"} <strong>{joinForm.plan==="premium"?"5000":"2000"} FCFA</strong> {lang==="fr"?"au numéro:":"to number:"}<br/>
                    <div style={{ background:"#FF980044", borderRadius:8, padding:"8px 12px", marginTop:6, fontFamily:"'Syne',sans-serif", fontWeight:800, fontSize:16, color:"#1a1a1a", textAlign:"center" }}>📞 695 548 173</div>
                  </div>
                </div>

                {/* Reference input */}
                <div style={{ marginBottom:14 }}>
                  <label style={{ fontFamily:"'Syne',sans-serif", fontWeight:600, fontSize:12, color:"#555", display:"block", marginBottom:5 }}>
...
⏳ En attente de vérification`);
                  ...
                  style={{ width:"100%", background:"#25D366", color:"#fff", border:"none", borderRadius:14, padding:"15px", fontFamily:"'Syne',sans-serif", fontWeight:700, fontSize:14 }}>
